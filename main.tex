...
The issues discussed in this chapter are part of the contribution, not a side note attached to it. Several were already in mind when the architecture was designed: the transparent safety supervisor was included partly to address accountability and certification, the dashboard was built so that a human can keep track of what the agent is doing, and the noise-augmented training was a deliberate choice to favour resilience over best-case performance. Even with all that, there is still a significant distance between this prototype and anything that could actually be deployed. Formal certification under DO-178C, liability arrangements, explainability of the DQN policy, and integration with real operational data pipelines would all need substantial work that sits as much in regulation and ethics as it does in engineering.
