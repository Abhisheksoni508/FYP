...
\begin{enumerate}
    ...
    \item \textbf{(Training only) Noise injection.} During training --- and only training --- 70\% of episodes have a small Gaussian noise added on top of the window. This is the trick that teaches the system what unreliable data looks like. At deployment time this block is switched off entirely.
